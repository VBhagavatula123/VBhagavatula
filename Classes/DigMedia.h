...
the year and the title is information that sub-classes are going to want so they are listed under protected, but not public because oublic also includes the main file.*/
